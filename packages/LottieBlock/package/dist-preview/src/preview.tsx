...
export type ComponentStructureProps = LottieBlockPreviewStructureProps;
  ...
  if (!lottieUrl) {
    return (
      <div className="flex items-center justify-center">
        <button 
        className='rounded-md  group px-4 py-2 bg-black text-white text-base font-medium  shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-green-300'
        onClick={() => setLottieUrlForLoad(originalUri)}>
